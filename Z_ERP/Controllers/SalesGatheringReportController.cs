...
{
    public class SalesGatheringReportController : Controller
    {
        private MainModel db = new MainModel();

        // GET: SalesGatheringReport
        ...
        // GET: SalesGatheringReport/Details/5
        ...
        // GET: SalesGatheringReport/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: SalesGatheringReport/Create
        ...
        // GET: SalesGatheringReport/Edit/5
        ...
        // POST: SalesGatheringReport/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: SalesGatheringReport/Delete/5
        ...
        // POST: SalesGatheringReport/Delete/5
