...
{
    public class TruckDetailReportController : Controller
    {
        private MainModel db = new MainModel();

        // GET: TruckDetailReport
        ...
        public JsonResult getTripsTotalAmount(int truckId, int TripID, string DateFrom, string DateTo)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                SqlCommand cmd = new SqlCommand("trc_TripExpensesGathering", con);
        ...
        // GET: TruckDetailReport/Details/5
        ...
        // GET: TruckDetailReport/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TruckDetailReport/Create
        ...
        // GET: TruckDetailReport/Delete/5
        ...
        // POST: TruckDetailReport/Delete/5
